# this is the main file that contains all the movies you would like
# to list within the web page
# this file uses the Movie class and fresh_tomatoes as following
# Firstly, It creates an instance of "Movie" class to each movie
# which is located in "Movie.py"
# Secondly, It creates a list of all movies created
# Finally, It Calls a method located inside "fresh_tomatoes.py"
# called "open_movies_page", giving
# it the created list of movies "movies" to create an HTML file
# to view these movies in a web page

import movie
import fresh_tomatoes

# using Movie.Movie to make instance of Class Movie to each movie
the_shawshank_redemption = movie.Movie(
...
good_bad_ugly = movie.Movie(
    ...
    "https://images-na.ssl-images-amazon.com/images/M/MV5BOTQ5NDI3MTI4MF5BMl5BanBnXkFtZTgwNDQ4ODE5MDE@._V1_SY1000_CR0,0,656,1000_AL_.jpg",  # NOQA
...
movies = [
    the_shawshank_redemption, the_godfather, the_godfather_ii,
    the_dark_knight, twelve_angry_men, schindler_list, pulp_fiction,
    the_lord_of_the_rings, good_bad_ugly
    ]
